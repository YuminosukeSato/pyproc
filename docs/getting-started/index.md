---
title: Getting Started Overview - pyproc
description: Your learning path for pyproc
...
[:octicons-arrow-right-24: First Integration Guide](first-integration.md)

**You'll learn**:
- Design request/response types
- Implement Python ML model
...
-   :material-shield-check:{ .lg .middle } **Type-Safe API**
    ...
    [:octicons-arrow-right-24: Learn More](../guides/type-safe-api.md)
...
-   :material-speedometer:{ .lg .middle } **Performance Tuning**
    ...
    [:octicons-arrow-right-24: Learn More](../guides/performance-tuning.md)
...
-   :material-rocket-launch:{ .lg .middle } **Deploy to Production**
    ...
    [:octicons-arrow-right-24: Learn More](../deployment/docker.md)
...
-   :material-alert-circle:{ .lg .middle } **Troubleshooting**
    ...
    [:octicons-arrow-right-24: Learn More](../deployment/troubleshooting.md)
